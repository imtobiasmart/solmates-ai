...
export default function ChatWidget() {
  ...
  return (
    <>
      <Button
        className="fixed bottom-4 right-4 rounded-full size-12 p-0"
      ...
      {isOpen && (
        <Card className="fixed bottom-20 right-4 w-[350px] h-[500px] p-4 flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold">Chat with Your AI Tutor</h3>
