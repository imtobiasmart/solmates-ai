...
const FeatureComparison = () => {
  ...
  const features = [
    { name: 'Personalization', solmates: true, others: false, description: 'Tailored learning paths that adapt to your unique needs and progress.' },
    { name: 'Science-backed learning', solmates: true, others: false, description: 'Rooted in cognitive science principles for optimal learning outcomes.' },
    { name: 'Career outcomes', solmates: true, others: false, description: 'Focus on skills and knowledge aligned with professional goals.' },
    { name: 'Verifiable credentials', solmates: true, others: false, description: 'Blockchain-backed certifications for your achievements.' },
    { name: 'Global accessibility', solmates: true, others: true, description: 'Learn from anywhere, anytime, with multilingual support.' },
    { name: 'Collaboration tools', solmates: true, others: false, description: 'Engage with peers and mentors for enhanced learning experiences.' },
    { name: 'Adaptive AI feedback', solmates: true, others: false, description: 'Real-time, personalized feedback to optimize your learning process.' },
  ]
      ...
      <TableBody>
        {features.map((feature) => (
          ...
          >
            ...
            <TableCell>{feature.solmates ? <CheckCircle className="text-green-500" /> : <XCircle className="text-red-500" />}</TableCell>
            <TableCell>{feature.others ? <CheckCircle className="text-green-500" /> : <XCircle className="text-red-500" />}</TableCell>
          </TableRow>
        ))}
      </TableBody>
      {hoveredFeature && (
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto max-w-7xl py-24 space-y-12">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="flex items-center justify-center">
              ...
              <div className="w-full h-64 bg-gradient-to-r from-primary/30 via-secondary/30 to-accent/30 rounded-lg flex items-center justify-center text-white">
        ...
        {/* Competitive Edge */}
        <section className="container mx-auto max-w-7xl py-24 space-y-12 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 rounded-xl">
          <h2 className="text-3xl font-bold tracking-tighter text-center sm:text-4xl md:text-5xl gradient-text">
            Why Solmates Over Other Tools?
          </h2>
          <p className="text-center text-lg text-muted-foreground">
            Unlike others that stop at practice quizzes and flashcards, Solmates focuses on your long-term growth—academically and professionally.
          </p>
          <FeatureComparison />
        </section>
        ...
        <section className="container mx-auto max-w-7xl py-24 space-y-12 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 rounded-xl">
          ...
          <p className="text-center text-lg text-muted-foreground">
            Students preparing for exams, professionals upskilling, and lifelong learners. Accessible for global learners with multilingual support and diverse learning paths.
          </p>
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                Ace your exams and build a strong foundation for your future career with personalized study plans.
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
              ...
              <CardContent>
                Stay ahead in your field with cutting-edge skills and knowledge tailored to your career goals.
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
              ...
              <CardContent>
                Explore new interests and hobbies with a learning companion that adapts to your pace and style.
              </CardContent>
            </Card>
          </div>
        </section>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <blockquote className="text-lg italic">
                  "At Solmates, we're not just building an AI tutor. We're creating a learning ecosystem that empowers everyone to reach their full potential through the Science of Learning. Our vision is a world where quality education is accessible to all, and where learning is a lifelong journey of growth and discovery."
                </blockquote>
